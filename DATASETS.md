...
|   |–– val/
```
- Download the split path from [Split_ImageNet](https://drive.google.com/file/d/1SvPIN6iV6NP2Oulj19a869rBXrB5SNFo/view) and put it to `$DATA/imagenet/split_ImageNet.json`.
