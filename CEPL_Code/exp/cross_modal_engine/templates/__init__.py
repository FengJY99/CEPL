from exp.cross_modal_engine.templates.template_pool import ALL_TEMPLATES
from exp.cross_modal_engine.templates.template_mining import MINED_TEMPLATES
from exp.cross_modal_engine.templates.hand_crafted import TIP_ADAPTER_TEMPLATES
