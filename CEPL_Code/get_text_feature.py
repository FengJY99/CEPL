...
from exp.cross_modal_engine.config import parser

import torch

from exp.cross_modal_engine.tools.utils import makedirs, set_random_seed
from exp.cross_modal_engine.transforms.default import build_transform
from exp.cross_modal_engine.datasets.utils import DatasetWrapper, get_few_shot_setup_name, get_few_shot_benchmark
from exp.cross_modal_engine.templates import get_templates
from exp.cross_modal_engine import clip
from exp.cross_modal_engine.clip import partial_model
...
def extract_features(image_encoder, data_source, transform, num_views=1, test_batch_size=2, num_workers=4):
    features_dict = {
